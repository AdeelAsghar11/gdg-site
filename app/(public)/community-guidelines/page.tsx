...
export const metadata = {
  title: 'Google Event Community Guidelines & Anti-Harassment Policy | GDGoC CUI Wah',
  description: 'Community guidelines and anti-harassment policy for all Google and GDGoC events.',
};
    ...
    <div className={styles.pageContainer}>
      <div className={styles.contentWrapper}>
        ...
        <ol className={styles.policyList}>
          <li>
            <strong>Be excellent to each other.</strong> We want the event to be an excellent experience for everyone regardless of gender identity and expression, sexual orientation, disabilities, neurodiversity, physical appearance, body size, ethnicity, nationality, race, age, religion, or other protected category. Treat everyone with respect. Participate while acknowledging that everyone deserves to be here -- and each of us has the right to enjoy our experience without fear of harassment, discrimination, or condescension, whether blatant or via micro-aggressions. Jokes shouldn’t demean others. Consider what you are saying and how it would feel if it were said to or about you.
          </li>
          <li>
        ...
        <h2 className={styles.subHeading}>Why this policy is important</h2>
        ...
        <h2 className={styles.subHeading}>License and attribution</h2>
        <p className={styles.paragraphText}>
        ...
        <div className={styles.footerLinks}>
          <a href="https://www.google.com/" target="_blank" rel="noopener noreferrer" className={styles.footerLink}>
            Google
          </a>
          <span className={styles.dot}>·</span>
          <a href="https://www.google.com/policies/" target="_blank" rel="noopener noreferrer" className={styles.footerLink}>
            Privacy & Terms
          </a>
        </div>
      </div>
